...
instance Print AbsCPP.Def where
  prt i = \case
    ...
    AbsCPP.DDecl type_ id_ args -> prPrec i 0 (concatD [prt 0 type_, prt 0 id_, doc (showString "("), prt 0 args, doc (showString ")"), doc (showString ";")])
...
instance Print AbsCPP.Arg where
  prt i = \case
    ...
    AbsCPP.ADeclNoId type_ -> prPrec i 0 (concatD [prt 0 type_])
...
instance Print AbsCPP.Exp where
  prt i = \case
    ...
    AbsCPP.EDot exp id_ -> prPrec i 15 (concatD [prt 15 exp, doc (showString "."), prt 0 id_])
    AbsCPP.EArrow exp id_ -> prPrec i 15 (concatD [prt 15 exp, doc (showString "->"), prt 0 id_])
    AbsCPP.EAppExp exp exps -> prPrec i 15 (concatD [prt 15 exp, doc (showString "("), prt 0 exps, doc (showString ")")])
    AbsCPP.EStringConcat exp str -> prPrec i 15 (concatD [prt 15 exp, printString str])
    AbsCPP.EIndex exp1 exp2 -> prPrec i 15 (concatD [prt 15 exp1, doc (showString "["), prt 0 exp2, doc (showString "]")])
    ...
    AbsCPP.EDeref exp -> prPrec i 13 (concatD [doc (showString "*"), prt 14 exp])
