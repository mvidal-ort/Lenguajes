...
transStm x = case x of
  ...
  AbsCPP.SFor stm1 exp1 exp2 stm2 -> failure x
...
transExp x = case x of
  ...
  AbsCPP.EDot exp id -> failure x
  AbsCPP.EArrow exp id -> failure x
  AbsCPP.EAppExp exp exps -> failure x
  AbsCPP.EStringConcat exp string -> failure x
  AbsCPP.EIndex exp1 exp2 -> failure x
  AbsCPP.EPIncr exp -> failure x
  AbsCPP.EPDecr exp -> failure x
  AbsCPP.EIncr exp -> failure x
  AbsCPP.EDecr exp -> failure x
  AbsCPP.ENot exp -> failure x
  AbsCPP.EDeref exp -> failure x
  AbsCPP.ETimes exp1 exp2 -> failure x
  AbsCPP.EDiv exp1 exp2 -> failure x
  AbsCPP.EMod exp1 exp2 -> failure x
